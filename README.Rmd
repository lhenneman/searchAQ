...
```
Where ```loc.serach``` is the local path of your SEARCH data (i.e., the directory that contains subdirectories named for each year). ```JSTdata``` will have the structure of a list containing hourly gas, meteorology, and ion measurements, and daily PM2.5:
...
OPE is a way to estimate the impacts of NOx emissions controls on ozone concentrations, and has been estimated
